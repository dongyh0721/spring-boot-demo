...
import spring.boot.start.ConfigApplication;

/**
 * @author dongyh
 * @since 2024-07-31 11:16:34
 */
@Slf4j
@SpringBootTest(classes = ConfigApplication.class,args = {"--spring.profiles.active=dev"})
public class DevConfigTest {
    ...
    @Test
    void run(){
        log.info("dev title:{}",title);
        log.info("dev server name:{}",serverName);
